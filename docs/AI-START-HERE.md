...
This public document routes an authorized agent to the right source. It intentionally contains no private organizational records, private Notion URLs, maintainer account details, deployment endpoints, or secrets.
...
The repository provides deploy tooling and runbooks. It does not prove that any live OCI deployment exists or satisfies production, backup, restore, E2EE, or acceptance gates. Do not infer legal ownership from repository visibility, licensing, or a knowledge hierarchy.
...
- report unavailable sources, unresolved conflicts, and any unproven live-deployment gates.
